return {
	...
	config = function()
		...
		vim.keymap.set("n", "<leader>gd", function()
			...
			if vim.g.fugitive_is_open and vim.g.fugitive_tab_id and vim.api.nvim_tabpage_is_valid(vim.g.fugitive_tab_id) then
			...
			if vim.g.diffview_is_open and vim.g.diffview_tab_id and vim.api.nvim_tabpage_is_valid(vim.g.diffview_tab_id) then
